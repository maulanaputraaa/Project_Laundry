...
class CuciKeringScreen extends StatefulWidget {
  @override
  _CuciKeringState createState() => _CuciKeringState();
}

class _CuciKeringState extends State<CuciKeringScreen> {
  ...
  void initState() {
    ...
    _getPriceFromDatabase('cuci kering');
  }
