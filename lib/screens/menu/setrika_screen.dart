...
class SetrikaScreen extends StatefulWidget {
  @override
  _SetrikaState createState() => _SetrikaState();
}

class _SetrikaState extends State<SetrikaScreen> {
